    ...
    <Container component={"main"} maxWidth="xs">
        ...
        <Box sx={{mt:8,display:"flex",
                 ...
                 alignItems:"center"
                    ...
                    <Avatar sx={{m1:1,bgcolor:"secondary.main"}}>
                        <LockOutlined/>
                    </Avatar>
                    ...
                    <Box component={"form"} sx={{mt:3}} onSubmit={registerUser}>
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12}>
                                <TextField autoComplete='new-password' fullWidth required name="password" id="password" label="Password" type="password"></TextField>
                            </Grid>
                        </Grid>
